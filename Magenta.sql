...
insert into deb_fort (idClaseEnemigo, idElemento, porcentajeDanio) values (1,1,0.2), (7,3,1.6), (2,3,0.1), (3,5,1.5), (4,2,0.7),(2,4,0.9),(6,3,1.6),(5,5,1.2),(7,4,1.7),(5,3,0.2),(6,5,1.4),(8,3,0.1),(8,4,1.8),(7,1,0.6),(4,2,0.5),(8,1,1.2);
-- Enemigos
...
-- Inventario objetos
insert into inventario (idHeroe, idObjeto, cantidadOBjeto) values (3,1,1), (2,2,2), (7,7,4), (6,4,6), (3,5,2), (8,6,1), (5,3,4), (4,4,1), (8,5,3), (1,7,5), (3,3,4), (2,1,1);
