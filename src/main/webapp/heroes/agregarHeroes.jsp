        ...
        <div class="fondo_imagen">
            ...
            <div class='container' style="margin-top: 30px;">
                ...
                <div class="pt-4 titlecolor">
                    <div class="col-lg-6">
                        <h1 class='text-dark' class='text-dark' style="color: white !important;font-weight: bold ">Agregar Heroes</h1>
                    </div>
                </div>
                <!--FINISH TITLE-->
                                ...
                                <div class="ibox-body" style="padding-top: 20px; padding-bottom: 20px;padding-left: 15px;padding-right: 15px" >
                                    ...
                                    <form method="post" action="<%=request.getContextPath()%>/HeroeServlet?action=guardarHeroe">
                                        ...
                                        <div class="form-group" style="text-align: right">
                                            <button type="submit" class="btn btn-primary"> Agregar Heroe</button>
