                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a type="button" class="btn btn-primary"
                               href="<%=request.getContextPath()%>/HeroeServlet?action=editarHeroes&id=<%=heroe.getIdHeroe()%>">
                        ...
                        <td>
                            <a type="button" class="btn btn-danger"
                               ...
                               href="<%=request.getContextPath()%>/HeroeServlet?action=borrarEnemigos&id=<%=heroe.getIdHeroe()%>">
