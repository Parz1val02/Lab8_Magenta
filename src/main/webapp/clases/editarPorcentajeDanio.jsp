...
<div class="fondo_imagen">
    ...
    <div class='container' style="margin-top: 30px;">
        ...
        <div class="pt-4 titlecolor">
            <div class="col-lg-6">
                <h1 class='text-dark' class='text-dark' style="color: #6f2e91 !important;font-weight: bold ">Editar Porcentaje Danio</h1>
            </div>
        </div>
        <!--FINISH TITLE-->
                ...
                <div class="container" style=" height: 100%">
                    ...
                    <div class="ibox" style="align-content: center; color: white; background-color: #332d2d; border: none"> <!--class="ibox"-->
                        ...
                        <div class="ibox-body" style="padding-top: 20px; padding-bottom: 20px;padding-left: 15px;padding-right: 15px" >
                            ...
                            <form method="post" action="<%=request.getContextPath()%>/ClaseServlet?action=actualizarPorcentajeDanio">
                                <!-- 1era fila -->
                                ...
                                <div class="form-group" style="text-align: right">
                                    ...
                                    <a href="<%=request.getContextPath()%>/ClaseServlet?action=listaDebFort&id=<%= DebFortPorClaseYElemento.getClaseEnemigo().getIdClaseEnemigo()%>" class="btn btn-secondary">Cancelar</a>
                                </div>
