...
<jsp:useBean type="java.util.ArrayList<com.magenta.lab8_magenta.model.beans.Objeto>" scope="request" id="catalogoObjetosNo"/>
        ...
        <div class="fondo_imagen">
            ...
            <div class = "container-fluid" style="background-color: #c40aa8  !important;">    <!--rgb(232 17 187 / 94%) -->
                <div class="container" >
                    <jsp:include page="/includes/navbar.jsp">
                        <jsp:param name="page" value="agregarObjetoInventario"/>
                    </jsp:include>
                </div>
            </div>
            <!--FINISH MENU-->
            ...
            <div class='container' style="margin-top: 30px;">
                ...
                <div class="pt-4 titlecolor">
                    <div class="col-lg-6">
                        <h1 class='text-dark' class='text-dark' style="color: #6f2e91 !important;font-weight: bold ">Agregar Objeto en el inventario de <%=heroe.getNombre()%></h1>
                    </div>
                </div>
                <!--FINISH TITLE-->
                        ...
                        <div class="container" style=" height: 100%">
                            ...
                            <div class="ibox" style="align-content: center; color: white; background-color: transparent; border: none"> <!--class="ibox"-->
                                ...
                                <div class="ibox-body" style="padding-top: 20px; padding-bottom: 20px;padding-left: 15px;padding-right: 15px" >
                                    ...
                                    <form method="post" action="<%=request.getContextPath()%>/InventarioServlet?action=guardarObjetoInventario">
                                        <!-- 1era fila -->
                                        ...
                                        <div class="row g-2">
                                            ...
                                            <div class="col-md">
                                                ...
                                                <div class="form-floating" style="margin-bottom: 15px;">
                                                    ...
                                                    <select style="background-color: #4d4545;color: white" class="form-select" id="floatingSelectGrid3" name="idObjeto">
                                                        <% for (Objeto objetos : catalogoObjetosNo) { %>
                                                        <option value="<%=objetos.getIdObjeto()%>"><%=objetos.getNombreObjeto()%></option>
                                                        <% } %>
                                                    </select>
                                                    <label style="color: white" for="floatingSelectGrid3" class="label-form-flujousuario">Nombre Objeto</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row g-2">
                                            ...
                                            <div class="col-md">
                                                <div class="form-floating" style="margin-bottom: 15px;">
                                                    <div class="form-floating" style="margin-bottom: 15px;">
                                                        <input style="background-color: #4d4545;color: white" type="text" class="form-control <%=error1!=null?"is-invalid":""%> <%=error2!=null?"is-invalid":""%> <%=error3!=null?"is-invalid":""%>" id="floatingInputGrid3" placeholder="Cantidad" name="cantidad" required>
